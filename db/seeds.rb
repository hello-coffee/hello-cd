...
Category.create(:category_name => "ロック/ポップス")
Category.create(:category_name => "クラシック")
Category.create(:category_name => "ソウル/クラブ/ラップ")
Category.create(:category_name => "カントリー/ブルース")
Category.create(:category_name => "ジャズ")
Category.create(:category_name => "ヒーリング/ニューエイジ")
Category.create(:category_name => "K-POP/ワールド")
Category.create(:category_name => "サウンドトラック")
Category.create(:category_name => "アニメ/ゲーム")
...
# Cart.create(:user_id => 1, :order_id => 1, :address_id => 1)
# Cart.create(:user_id => 1, :order_id => 2, :address_id => 2)
# Cart.create(:user_id => 1, :order_id => 3, :address_id => 3)
...
# User.create(:last_name => "山田2", :first_name => "太郎", :last_name_kana => "ヤマダ", :first_name_kana => "タロウ", :post_code => "222-2222", :address => "東京都渋谷区神泉町1-1-1", :tel => "22222222222", :email => "b2@b2", :password => "aaaaaa", :deleted_at => "")
